...
using NET_API_SQL_Reservas.Models;

namespace NET_API_SQL_Reservas.Controllers
{
    ...
    public class ReservasController : ControllerBase
    {
        ...
        public async Task<ActionResult<Reserva>> PostReserva(Reserva reserva)
        {
            ...
            {
                if (ReservaExists(reserva.InvestigadorDNI))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetReserva", new { id = reserva.InvestigadorDNI }, reserva);
        }
        ...
        {
            return _context.Reservas.Any(e => e.InvestigadorDNI == id);
        }
    }
}
